...
int main()
{
    ...
    /*
        ...
        std::cout << "std::strcmp (" << string_data3 << "," << string_data4 << ") : "
                  << std::strcmp(string_data4, string_data3) << std::endl;

        string_data1 = "Alabama";
        string_data2 = "Alabamb";

        // string_data3 = "Alabama";//we are not allowed to assign a new value to an array after it has been declared. This is because arrays in C++ have a fixed size and cannot be resized or reassigned after they are created.
    ...
    const char *string_data1{"Aalabama"};
    const char *string_data2{"Bblabama"};
    size_t n{3};
    std::cout << std::endl;
...
*/
    ...
    while ((result = std::strchr(str, target)) != nullptr)
    {
        ...
        // str++ will go letter to letter till not find the charachter
