#include <iostream>
#include <cctype>//for character function
...
int main()
{
    ...
    size_t blank_count{};//size_t is an unsigned integer type that is used to represent the size of objects in bytes. It is defined in the <cstddef> header and is typically used for array indexing and loop counters.
